...
export default function ContactClient({ contactSettings }) {
  ...
  const mapEmbedUrl = activeLocation.mapEmbedUrl;
        ...
        <div className="container mx-auto px-4 md:px-6 mt-20">
          ...
          >
            ...
            >
              ...
              {settings.phoneNumbers?.map((p, idx) => (
                <p key={idx} className="text-gray-400 mb-1">{p}</p>
              ))}
            </motion.a>
            ...
            >
              ...
              {settings.emails?.map((e, idx) => (
                <p key={idx} className="text-gray-400">{e}</p>
              ))}
            </motion.a>
          ...
          >
            ...
            <motion.div variants={fadeRight} className="space-y-8">
              ...
              >
                <h3 className="text-2xl font-bold mb-6 text-white text-center">CONNECT WITH US</h3>
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-12">
                ...
                <motion.div variants={fadeRight} className="space-y-4">
                  {[
                    { icon: Phone, text: settings.phoneNumbers?.slice(0, 2).join(' · ') || "Contact us" },
                    { icon: Mail, text: settings.emails?.[0] || "Email us" },
          ...
          >
            ...
            <div className="relative w-full h-[400px] md:h-[500px] group">
              ...
              >
                ...
                <p className="text-sm text-gray-300 mb-3">{activeLocation.address}</p>

                <div className="space-y-2">
                  <p className="text-xs text-gray-400">Contact:</p>
                  <div className="flex items-start gap-2 text-xs">
                    <Phone className="w-3 h-3 text-gray-500 mt-0.5" />
                    <span className="text-gray-300">{settings.phoneNumbers?.[0]}</span>
                  </div>
                  <div className="flex items-start gap-2 text-xs">
                    <Mail className="w-3 h-3 text-gray-500 mt-0.5" />
                    <span className="text-gray-300">{settings.emails?.[0]}</span>
                  </div>
                </div>
              </motion.div>
            </div>
            ...
            <div className="p-4 border-t border-gray-700/50 flex flex-wrap items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm text-gray-400">
                  {activeLocation.lat ? activeLocation.lat.toFixed(4) : '25.1345'}° N, {activeLocation.lng ? activeLocation.lng.toFixed(4) : '55.2356'}° E
                </span>
              </div>
