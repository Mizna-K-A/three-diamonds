    ...
    <>
      ...
      <main className="min-h-screen bg-[#050608] text-white pb-32 overflow-x-hidden">
        ...
        <section className="relative min-h-screen overflow-hidden">
          ...
          {/* Three-panel image mosaic — desktop only */}
          ...
          {/* Text */}
          <div className="relative z-10 container mx-auto px-4 md:px-6 flex flex-col justify-center min-h-screen pt-28 lg:pt-32 pb-16 lg:pb-20">

            {/* ServiceNavigation — hidden on mobile & tablet */}
            <div className="hidden lg:block">
              <ServiceNavigation />
            </div>

            <motion.div className="mt-8 lg:mt-12 max-w-[520px]" initial="hidden" animate="show" variants={stagger}>
              ...
              <div className="mb-8 lg:mb-10 overflow-hidden">
                <motion.div variants={clipReveal} custom={0.05} className="overflow-hidden mb-1">
                  <h1 className="text-[clamp(2.8rem,8vw,6.5rem)] font-black leading-[0.92] tracking-[-0.04em] text-white">
                    Capital
                  </h1>
                </motion.div>
                <motion.div variants={clipReveal} custom={0.18} className="overflow-hidden mb-1">
                  <h1 className="text-[clamp(2.8rem,8vw,6.5rem)] font-black leading-[0.92] tracking-[-0.04em]"
              ...
              <motion.p variants={fadeUp} custom={0.44}
                className="text-[13px] text-white/38 max-w-[310px] leading-[1.95] mb-9 lg:mb-11 pl-4 border-l-2 border-white/8">
              ...
              {/* CTA row */}
              <motion.div variants={fadeUp} custom={0.52} className="flex items-center gap-5 mb-10 lg:mb-16">
              ...
              <motion.div
                ...
                className="block lg:hidden relative w-full h-[220px] sm:h-[280px] rounded-2xl overflow-hidden shadow-[0_30px_80px_rgba(0,0,0,0.7)] mb-8"
              >
                <Image src="/capitalmarketing-pics/capital-4.jpg" alt="Capital" fill priority className="object-cover" />
                <div className="absolute inset-0 bg-gradient-to-t from-[#050608]/60 to-transparent" />
                <div className="absolute bottom-4 left-4 bg-[#050608]/70 backdrop-blur-xl border border-white/10 rounded-xl px-4 py-3 flex items-center gap-2.5">
                  <DollarSign className="w-3.5 h-3.5 text-white/60" />
                  <div>
                    <p className="text-[9px] text-white/35 leading-none mb-0.5">Capital Deployed</p>
                    <p className="text-base font-black text-white leading-none">$5B+</p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div variants={fadeUp} custom={0.60}
                ...
                {[
                  ...
                  <div key={label}>
                    ...
                    <p className="text-[9px] sm:text-[10px] text-white/25 uppercase tracking-widest mt-0.5">{label}</p>
                  </div>
                ))}
              </motion.div>
            </motion.div>
          ...
          {/* Floating data card — desktop only */}
          <motion.div
        ...
        <section className="mt-20 lg:mt-28 relative">
          ...
          <Reveal variants={scaleIn} className="container mx-auto px-4 md:px-6">
            <div className="relative w-full h-[360px] sm:h-[420px] lg:h-[480px] rounded-3xl overflow-hidden shadow-[0_60px_140px_rgba(0,0,0,0.8)]">
              ...
              <motion.div
                className="absolute inset-0 flex items-center px-6 sm:px-10 md:px-16"
                initial="hidden" whileInView="show"
                viewport={{ once: false, margin: '-60px' }} variants={stagger}
              >
                <div className="max-w-lg">
                  <motion.p variants={staggerItem}
                    className="text-[10px] font-black tracking-[0.28em] uppercase text-white/25 mb-5 lg:mb-6 flex items-center gap-2">
                    <span className="w-5 h-px bg-white/15" /> Our Approach
                  </motion.p>
                  <motion.h2 variants={staggerItem}
                    className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black tracking-[-0.025em] text-white leading-[1.0] mb-5 lg:mb-7">
                    Advisory That Connects You to Capital
                  </motion.h2>
                  <motion.p variants={staggerItem}
                    className="text-[13px] text-white/45 leading-[1.9] mb-4 hidden sm:block">
                  ...
                  <motion.p variants={staggerItem}
                    className="text-[13px] text-white/45 leading-[1.9] hidden md:block">
              ...
              {/* Benefits list — right side, xl only */}
              <motion.div
          ...
          {/* Benefits list — mobile/tablet (below image) */}
          <motion.div
            className="xl:hidden container mx-auto px-4 md:px-6 mt-6"
            initial="hidden" whileInView="show"
            viewport={{ once: false }} variants={stagger}
          >
            <div className="bg-[#0b0e12] border border-white/[0.06] rounded-2xl px-6 py-5">
              <p className="text-[10px] font-black tracking-[0.22em] uppercase text-white/28 mb-4">Why Choose Us</p>
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-0">
                {benefits.map((b, i) => (
                  <motion.div key={i} variants={staggerItem}
                    className="flex items-center gap-3 py-3 border-b border-white/[0.06] text-[12px] text-white/50 last:border-0">
        ...
        <section id="services" className="container mx-auto px-4 md:px-6 mt-24 lg:mt-32 relative">
          ...
          <Reveal variants={fadeUp} className="mb-10 lg:mb-14 relative z-10">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
              <div>
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-[-0.025em] text-white">Our Services Include</h2>
              </div>
              <p className="text-xs text-white/18 hidden sm:block text-right leading-relaxed">Full-spectrum<br />capital advisory</p>
            </div>
          </Reveal>

          {/* Row 1 — Two big image cards */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            <motion.div
              className="relative rounded-3xl overflow-hidden min-h-[260px] sm:min-h-[280px] shadow-[0_30px_80px_rgba(0,0,0,0.65)]"
            ...
            >
              ...
              <motion.div className="absolute bottom-0 left-0 right-0 p-6 sm:p-7"
          ...
          <motion.div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-4"
            initial="hidden" whileInView="show"
            viewport={{ once: false, margin: '-60px' }} variants={stagger}>
            {[
              ...
              <motion.div key={label} variants={staggerItem}
                className="group bg-[#0b0e12] border border-white/[0.05] rounded-2xl p-5 sm:p-6 cursor-default relative overflow-hidden"
                ...
                <motion.div
                  className="relative z-10 w-9 h-9 rounded-xl bg-white/[0.06] border border-white/[0.07] flex items-center justify-center mb-4 sm:mb-5"
                ...
                <h3 className="relative z-10 text-sm font-black text-white/60 group-hover:text-white/92 transition-colors leading-snug">{label}</h3>
              </motion.div>
            ))}
          </motion.div>

          {/* Row 3 — wide description card + 2 narrow */}
          <motion.div className="grid grid-cols-1 sm:grid-cols-12 gap-3 sm:gap-4"
            initial="hidden" whileInView="show"
            viewport={{ once: false, margin: '-60px' }} variants={stagger}>

            <motion.div variants={staggerItem}
              className="sm:col-span-12 md:col-span-6 group bg-[#0b0e12] border border-white/[0.05] rounded-3xl p-7 sm:p-8 flex gap-5 sm:gap-6 cursor-default relative overflow-hidden"
            ...
            <motion.div variants={staggerItem}
              className="sm:col-span-6 md:col-span-3 group bg-[#0b0e12] border border-white/[0.05] rounded-3xl p-6 sm:p-7 cursor-default relative overflow-hidden"
              whileHover={{ borderColor: 'rgba(255,255,255,0.12)', y: -4, transition: { duration: 0.2 } }}>
              <div className="absolute inset-0 bg-gradient-to-br from-white/[0.03] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-3xl" />
            ...
            <motion.div variants={scaleIn}
              className="sm:col-span-6 md:col-span-3 relative rounded-3xl overflow-hidden min-h-[160px]"
        ...
        {/* ─── NUMBER SHOWCASE ─── */}
        <section className="mt-24 lg:mt-32 border-t border-b border-white/[0.05] bg-[#08090c]">
          <div className="container mx-auto px-4 md:px-6">
            <motion.div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-y md:divide-y-0 divide-white/[0.05]"
              initial="hidden" whileInView="show"
              viewport={{ once: false, margin: '-60px' }} variants={stagger}>
              {[
                ...
                <motion.div key={label} variants={staggerItem}
                  className="py-8 sm:py-12 px-5 sm:px-8 group hover:bg-white/[0.02] transition-colors duration-300"
                  whileHover={{ y: -2, transition: { duration: 0.18 } }}>
                  <p className="text-[9px] sm:text-[10px] font-black tracking-[0.22em] uppercase text-white/22 mb-2 sm:mb-3 leading-tight">{label}</p>
                  <p className="text-3xl sm:text-4xl md:text-5xl font-black text-white mb-1">
                    {prefix}<Counter to={to} suffix={suffix} duration={1.8} />
                  </p>
                  <p className="text-[10px] sm:text-[11px] text-white/25">{sub}</p>
                </motion.div>
              ))}
            </motion.div>
          </div>
        ...
        {/* ─── CTA ─── */}
        <section className="mt-24 lg:mt-32 container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-5 items-stretch min-h-[440px]">

            {/* Left image — hidden on mobile, shown on lg+ */}
            <Reveal variants={fadeLeft} className="hidden lg:block lg:col-span-3 relative rounded-3xl overflow-hidden">
              <Parallax speed={0.1} className="absolute inset-0 w-full h-[115%] -top-[7%]">
            ...
            {/* Centre text */}
            <motion.div
              className="lg:col-span-6 bg-[#0b0e12] border border-white/[0.06] rounded-3xl p-8 sm:p-10 md:p-14 flex flex-col justify-between"
              initial="hidden" whileInView="show"
              viewport={{ once: false }} variants={stagger}>
              <div>
                <motion.p variants={staggerItem}
                ...
                <motion.h2 variants={staggerItem}
                  className="text-3xl sm:text-4xl md:text-5xl font-black leading-[0.97] tracking-[-0.03em] text-white mb-2">
                  Optimize Your
                </motion.h2>
                <motion.h2 variants={staggerItem}
                  className="text-3xl sm:text-4xl md:text-5xl font-black leading-[0.97] tracking-[-0.03em] text-white/18 mb-7 lg:mb-8">
                  Capital Structure.
                </motion.h2>
                <motion.p variants={staggerItem}
                  className="text-[13px] text-white/35 leading-[1.9] max-w-sm border-l-2 border-white/8 pl-4 mb-8 lg:mb-10">
            ...
            {/* Right stacked images — hidden on mobile, shown on lg+ */}
